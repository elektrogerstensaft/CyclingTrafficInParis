...
# save results
data = {'MAE train': [mae_decision_tree_train, mae_decision_tree_train_splitter],
...
"""
This part was used for a hyper parameter tuning. It still can be used but leads to unstable results with very long calculating times!
