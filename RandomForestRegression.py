...
# model 2
rfr_2 = RandomForestRegressor(n_estimators=85, max_depth=4, random_state=42)
...
plt.title("Random Forest Regression (Model 1) for bike countings")
plt.show()
...
plt.xlabel("Predicted values")
plt.ylabel("True values")
plt.title("Random Forest Regression (Model 2) for bike countings")
plt.show()
